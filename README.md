...
=====
The main font end page configuration declared at the formStructure variable

each element of this array is define one block of page.
**Properties:**
***a - array. List of modes allowed for this block***
***n - string. Label of block***
***p - string. Path of http reques generated by actions from this block***
***c - array. Elements of this block ***

An elements of block represented as array of input config
**properties**
***n - string. Action type for send to the server***
***t - string. Type of input***
***f - string. Name of property serverside value***
***min - number. Min value (only for rabge)***
***max - number. Max value (only for rabge)***
